...
export default function LocationSection() {
  return (
    <motion.section
      ...
      className="relative isolate flex min-h-[480px] items-center overflow-hidden border-t"
    >
      <Image
        src="/gallery/about -3.png"
        alt="Entrance gate of Lodhi Biradari Cooperative Housing Society in Surjani Sector 12, Karachi"
        fill
        priority
        className="object-cover object-top"
        sizes="100vw"
      />
      <div className="absolute inset-0 bg-gradient-to-r from-primary via-primary/60 to-primary/25" />
